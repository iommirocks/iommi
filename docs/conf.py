...
latex_documents = [
  ('index', 'tri.form.tex', u'tri.form Documentation',
...
man_pages = [
    ('index', 'tri.form', u'tri.form Documentation',
...
texinfo_documents = [
  ('index', 'tri.form', u'tri.form Documentation',
   u'Anders Hovmöller', 'tri.form', 'One line description of project.',
   'Miscellaneous'),
]

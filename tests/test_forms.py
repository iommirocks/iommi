...
#
#     assert MyForm(request=req('post', **{'foo': 'b', '-': ''})).fields_by_name.foo.value is b
#     assert MyForm(request=req('post', **{'foo': 'fisk', '-': ''})).fields_by_name.foo.errors == {'fisk not in available choices'}

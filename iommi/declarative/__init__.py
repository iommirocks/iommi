...
def set_declared(cls: type, value: dict, parameter: str = 'members'):
    setattr(cls, '_declarative_' + parameter, value)


def get_declared(cls: type, parameter: str = 'members') -> dict:
    """
...
def get_members(cls, member_class=None, is_member: Callable[[object], bool] | None = None, sort_key: Callable[[object], object] | None = None, _parameter=None):
    """

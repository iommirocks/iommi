...
def test_traverse_on_iommi():
    ...
    assert actual == {
        ...
        'ajax_enhance': 'parts/some_form/assets/ajax_enhance',
        ...
        'form/ajax_enhance': 'parts/a_table/query/form/assets/ajax_enhance',
        ...
        'some_other_form/ajax_enhance': 'parts/some_other_form/assets/ajax_enhance',

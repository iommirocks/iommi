...
class Column(Part):
    ...
    def __init__(self, **kwargs):
        ...
        :param attr: What attribute to use, defaults to same as name. Follows django conventions to access properties of properties, so `foo__bar` is equivalent to the python code `foo.bar`. This parameter is based on the name of the Column if you use the declarative style of creating tables.
        ...
        :param cell: Customize the cell, see `howto on rendering <https://docs.iommi.rocks/cookbook_tables.html#how-do-i-customize-the-rendering-of-a-cell>`_ and `howto on links <https://docs.iommi.rocks/cookbook_tables.html#how-do-i-make-a-link-in-a-cell>`_

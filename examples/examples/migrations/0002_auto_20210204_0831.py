...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='album',
            name='artist',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='albums', to='examples.Artist', verbose_name='artist'),
        ),
        migrations.AlterField(
            model_name='album',
            name='name',
        ...
        migrations.AlterField(
            model_name='track',
            name='album',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tracks', to='examples.Album', verbose_name='album'),
        ),
        migrations.AlterField(
            model_name='track',
            name='duration',
